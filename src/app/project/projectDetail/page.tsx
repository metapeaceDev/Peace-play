    ...
    <>
      <div className="relative flex h-[300px] lg:h-[800px] w-full mix-blend-overla mt-[56px]">
        ...
        <div className="absolute top-[35%] px-20 w-full z-10">
          <p className="text-white text-7xl mb-4">ไทบ้านเดอะซีรีส์</p>
          <p className="text-white text-base tracking-widest">
            2021 | 7+ | 1h 42m | Language : English - spanish
          </p>
            ...
            <div className="flex gap-5">
              ...
              <div className="w-[32%]">
                ...
                <p className="text-white font-extrabold tracking-widest">
                  A coloumbian teenange girl has to face the
                  ถ้าชอบก็แชร์กันให้กันด้วยคนละทีนะครับ
                  หากมีข้อมูลผิดพลาดต้องขออภัยด้วยน้าสปอยหนัง
                  เมื่อชายโล้นคนนี้ยอมติดคุกเพื่อเข้าไปล้างแค้นให้ลูกชายของตัวเอง
                </p>
        ...
        <div className="container mx-auto px-8 py-8 ">
          <div className="hidden md:block">
            <div className="flex justify-between mt-6">
              ...
              <div className="w-[300px] h-[100px]">
                <Button
                  className="bg-[#2F5D86] text-white text-[18px]"
                  radius={"sm"}
                  fullWidth={true}
                  onPress={onOpen}
                >
          ...
          <div className="md:hidden flex justify-center ">
            <div className="flex-col ">
              ...
              <div className="w-[300px] h-[100px]">
                <Button
                  className="bg-[#2F5D86] text-white text-[16px]"
                  radius={"sm"}
                  fullWidth={true}
                >
                  ซื้อสคริป
