    ...
    <div className="container mx-auto p-4">
      ...
      <div className="lg:hidden pt-4">
        <div className="w-full lg:w-[60%]">
          <video className="w-full h-[300px]" controls></video>
        </div>
      </div>
      ...
      <div className="block lg:flex justify-between gap-3 pt-4">
        ...
        {/* <div className="hidden lg:block">
          <div className="w-full absolute">
            <video className="w-full h-[500px]" ref={videoRef} muted controls>
              <source
                src="https://ol-academy.sgp1.cdn.digitaloceanspaces.com/11.2_D1%20%E0%B8%84%E0%B8%A5%E0%B8%B2%E0%B8%AA%E0%B8%AA%E0%B8%AD%E0%B8%99%20EP.9.2%20OFFLINE%20%E0%B8%9E%E0%B8%B5%E0%B9%88%E0%B9%80%E0%B8%9A%E0%B8%8D%20%E0%B8%9E%E0%B8%B5%E0%B9%88%E0%B8%9B%E0%B8%B2%E0%B8%A3%E0%B9%8C%E0%B8%84.mp4"
                type="video/mp4"
              />
            </video>
            <div className=" relative z-10">12</div>
          </div>
        </div> */}
        <div>
          <div className="App">
            <video
              ...
              controls
              autoPlay
              className=" absolute top-10 right-10 z-[] w-[50%] h-[60vh]"
            >
              <source
            ...
            <div className="text-wrapper text-red-700 z-10">
