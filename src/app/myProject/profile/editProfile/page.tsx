...
const EditProfile = () => {
  ...
  useEffect(() => {
    if (user) {
      ...
      setPhotoURL(user.photoURL || "/assets/profile-picture-5.jpg");
    }
  }, [user]);
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      alert("บันทึกข้อมูลเรียบร้อยแล้ว / Profile Updated!");
      window.location.reload(); 
    } catch (error) {
      console.error("Error updating profile:", error);
      alert("เกิดข้อผิดพลาด / Error saving profile");
    } finally {
      setIsLoading(false);
    }
  };

  if (!user) return <div className="p-10 flex justify-center"><Spinner /></div>;
      ...
      <div className="bg-white p-4 rounded-lg">
        ...
        <div className="flex justify-start gap-4">
          <Image
            priority
            className="rounded"
            src={photoURL || "/assets/profile-picture-5.jpg"} // Bind to State
        ...
        <div className="pt-5">
          ...
          <div className="flex justify-between">
            ...
            <button
              ...
              onClick={handleSave}
              disabled={isLoading}
              className={`w-full h-[45px] text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800 ${isLoading ? 'opacity-50 cursor-not-allowed' : ''}`}
            >
